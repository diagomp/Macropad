...
public class SystemController {
	...
	public void executeCommand (String cmd) {
		...
		if (cmd != null && cmd.length() > 0) {
			...
			//Hasta aqu� tenemos una lista de todos los comandos que se ejecutan uno detr�s del otro.
			for (int i = 0; i < cmds.size(); i++) {
				//Aqu� ejecutaremos todos los comandos que son simult�neos
	...
	private int getConstant (String c) {
		if (c.length() == 1) {
			//N�meros o letras -- coinciden con sus c�digos ASCII
			char ch = c.charAt(0);
